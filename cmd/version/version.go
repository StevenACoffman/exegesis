...
//
//	go build -ldflags "-X 'github.com/StevenACoffman/exegesis/cmd/version.Version=v1.2.3'"
var Version = "dev"
...
func New(parent *root.Config) *Config {
	...
	cfg.Command = &ff.Command{
		Name:      "version",
		Usage:     "exegesis version [--json]",
		ShortHelp: "print version information",
		LongHelp: `Print build and version information for this exegesis binary.
